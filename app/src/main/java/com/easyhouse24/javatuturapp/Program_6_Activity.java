...
public class Program_6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program_6_);
        hanRun();

        toolbar = (Toolbar) findViewById(R.id.toolbar_programs_6);
    ...
    private void codeView(){
        ...
        CodeView codeView = (CodeView) findViewById(R.id.code_view_6);

        codeView.setOptions(Options.Default.get(this)
                .withLanguage("java")
                .withCode(R.string.listing_java_6)
    ...
    public void copyClipboard() {
        ...
        String string = getString(R.string.listing_java_6);
