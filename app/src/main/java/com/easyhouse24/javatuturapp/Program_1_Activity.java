...
public class Program_1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program_1_);

        hanRun();

        toolbar = (Toolbar) findViewById(R.id.toolbar_programs_1);
    ...
    private void codeView(){
        ...
        codeView.setOptions(Options.Default.get(this)
                .withLanguage("java")
                .withCode(R.string.listing_java_1)
    ...
    public void copyClipboard() {
        ...
        String string = getString (R.string.listing_java_1);
