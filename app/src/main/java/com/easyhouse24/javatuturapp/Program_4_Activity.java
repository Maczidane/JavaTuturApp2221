...
public class Program_4_Activity extends AppCompatActivity {

    private Toolbar toolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_program_4_);
        hanRun();

        toolbar = (Toolbar) findViewById(R.id.toolbar_programs_4);
    ...
    private void codeView(){
        ...
        CodeView codeView = (CodeView) findViewById(R.id.code_view_4);

        codeView.setOptions(Options.Default.get(this)
                .withLanguage("java")
                .withCode(R.string.listing_java_4)
    ...
    public void copyClipboard() {
        ...
        String string = getString(R.string.listing_java_4);
