...
public class Program_5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program_5_);

        hanRun();

        toolbar = (Toolbar) findViewById(R.id.toolbar_programs_5);
    ...
    private void codeView(){
        ...
        CodeView codeView = (CodeView) findViewById(R.id.code_view_5);

        codeView.setOptions(Options.Default.get(this)
                .withLanguage("java")
                .withCode(R.string.listing_java_5)
    ...
    public void copyClipboard() {
        ...
        String string = getString (R.string.listing_java_5);
